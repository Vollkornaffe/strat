...
SRCS_GAME=game/Client.cc game/Graphics.cc game/Main.cc game/Map.cc game/Math.cc game/Sim.cc game/SimState.cc game/SimSystems.cc game/InterpState.cc game/Input.cc game/Terrain.cc game/SimComponents.cc $(SRCS_OPENGL) $(SRCS_UTIL)
